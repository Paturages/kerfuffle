...
export default props => (<div className="Combat">
  ...
  {props.abilities.map(a => <button className={`Combat__ability ${a.ult ? 'Combat__ability--ultimate' : ''}`} onClick={() => props.onAttackSelect(a)} disabled={
      !props.canAttack ||
      (a.mp && props.mp < a.mp) ||
      (a.ult && props.ult < a.ult) ||
      props.disabledAbilities.find(e => e.id === a.id)
    }>
    {a.ult && <div className="Combat__ability-ult-meter" style={{ width: `${props.ult >= a.ult ? 100 : 100 * (props.ult / a.ult)}%` }} />}
